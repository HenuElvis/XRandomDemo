...
import tokenxx.com.xrandomdemo.MainActivity;
import tokenxx.com.xrandomdemo.R;


public abstract class UEntropyActivity extends AppCompatActivity implements UEntropyCollector
    ...
    abstract Thread getGeneratingThreadWithXRandom(UEntropyCollector collector, String password);
